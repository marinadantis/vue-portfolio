  ...
  >
    ...
    <div class="flex flex-col gap-4">
      <div class="flex flex-col gap-1.5">
        <label for="name" class="text-sm font-semibold tracking-wide text-neutral-200">Name</label>
        <input
          required
          name="from_name"
          id="name"
      ...
      <div class="flex flex-col gap-2">
        ...
        <textarea
          ...
          name="message"
          id="message"
          placeholder="Tell me about your project, work or just say hello!"
          rows="3"
          class="rounded-lg border border-neutral-700 bg-neutral-800/40 p-2.5 text-sm text-white focus-within:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 focus:outline-hidden"
        ></textarea>
      </div>
    ...
    <p v-if="statusMessage === 'error'" class="mt-2 text-center text-sm font-medium text-rose-400">
