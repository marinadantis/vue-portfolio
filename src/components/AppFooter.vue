...
<template>
  <footer class="w-full bg-black">
    ...
    <div
      class="mx-auto flex w-[calc(100%-2rem)] max-w-5xl flex-col items-center p-4 sm:flex-row sm:justify-between md:w-[calc(100%-20rem)]"
    >
      <p class="text-sm text-neutral-400">
        &copy; 2026 <span class="font-medium text-neutral-300">Marina Dantis</span>. All Rights
        Reserved
      </p>
      ...
      <div class="flex gap-6">
        ...
        <a
          ...
          class="text-neutral-500 transition-colors duration-200 hover:text-neutral-300"
          aria-label="Email Me"
        >
          <svg
            class="h-5 w-5"
